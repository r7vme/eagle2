...
if(TensorFlow_FOUND)
  ...
  execute_process(
    COMMAND ${PYTHON_EXECUTABLE} -c "import tensorflow as tf; print(tf.__version__); print(tf.__cxx11_abi_flag__); print(tf.sysconfig.get_include()); print(tf.sysconfig.get_lib() + '/libtensorflow_framework.so'); print(tf.sysconfig.get_lib() + '/libtensorflow_cc.so')"
  ...
  list(GET TF_INFORMATION_LIST 4 TF_DETECTED_C_LIBRARY)
  ...
  FOREACH(_TensorFlow_VER ${_TensorFlow_TEST_VERSIONS})
    if("${TF_DETECTED_VERSION_MAJOR}.${TF_DETECTED_VERSION_MINOR}" STREQUAL "${_TensorFlow_VER}")
      ...
      set(TensorFlow_C_LIBRARY ${TF_DETECTED_C_LIBRARY})
